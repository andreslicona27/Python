...
sleep(2)
login_button = driver.find_element(By.XPATH, '//*[@id="content"]/div/div[1]/div/main/div[1]/main/div/div/header/div[1]/div[2]/div/button')
login_button.click()
...
cookies = driver.find_element(By.XPATH, '//*[@id="modal-manager"]/div/div/div/div/div[2]/button[1]')
cookies.click()
...
for n in range(100):
    ...
    try:
        ...
        try:
            match_popup = driver.find_element(By.CSS_SELECTOR, '.istMatch a')
            match_popup.click()

            # Catches the cases where the "like" button has not yet loaded, so wait 2 seconds before retying
